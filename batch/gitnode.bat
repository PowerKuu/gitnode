...
echo {"name":"%var%","version":"1.0.0","description":"","main":"%var%.ts","dependencies":{},"devDependencies":{},"scripts":{"dev": "nodemon --watch './**/*.ts' './**/*.js' --exec npx ts-node %var%.ts"},"author":"","license":"ISC"} >> package.json
type nul > %var%.ts
